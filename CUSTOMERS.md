...
（之後在主畫面隨時可以點**左上角那顆語言鍵**切換——鍵上顯示的是
**目前**的語言，點開會列出三種，打勾的就是現在用的。）
...
**不過通話內容留存的時間已經很短了**（2026-08-31 起）：掛斷 8 秒後就會
自動從資料庫刪除，沒刪成功的也會在下次開啟 App 時清掉。也就是說，
別人要看到內容，必須**剛好在你講電話的那幾分鐘之內**去翻資料庫。

- 客戶不多、彼此認識 → 可以接受
- 通話當下仍然讀得到 → 真的很敏感的價格，建議當面或用其他方式談
...
| 客戶說看不懂畫面 | 還是中文介面 | 點主畫面左上角語言鍵，選 Bahasa Indonesia；或設定頁最上面那張卡片 |
