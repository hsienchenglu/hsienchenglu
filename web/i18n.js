...
const I18N = {
  zh: {
    ...
    err_sw_activating: '背景服務還在啟動，請過幾秒再按一次「重新啟用」',
  ...
  id: {
    ...
    err_sw_activating: 'Layanan latar masih menyala, tunggu beberapa detik lalu tekan lagi',
  ...
  en: {
    ...
    err_sw_activating: 'The background service is still starting — wait a few seconds and tap again',
